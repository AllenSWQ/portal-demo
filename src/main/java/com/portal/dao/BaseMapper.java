...
public interface BaseMapper<T> {
    ...
    int delPerRole(@Param("id")String id);
    ...
    int delurole(@Param("uid")String userid);
    
    int addurole(@Param("uid")String userid, @Param("uname")String username);
    
    List<Permission> getUserMenu(@Param("userid") String userid);
    
    List<Permission> getSubUserMenu(@Param("userid") String userid);
    
    int logMsg(LogData log);
    
    List<T> getSelect(@Param("params")Map<String, Object> params);
