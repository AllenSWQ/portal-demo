...
public interface IRoleService {
	...
	int getRoleByRoleName(String name) throws Exception;
	
	int deleteSubPerByRidPid(String rid, String pid) throws Exception;
	
	int deleteSubPerByRid(String rid) throws Exception;
}
